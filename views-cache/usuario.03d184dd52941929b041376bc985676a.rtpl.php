...
<div class="content">
    <div class="content-inside">
        <div class="my-4">
            ...
            <center><p>Bem vindo <b><?php echo getUsuarioNome(); ?></b> ao Sistema Web de Suporte Técnico da Loja/Empresa 1.</p>
           ...
           <center> <p>Bem vindo <b><?php echo getUsuarioNome(); ?></b> ao Sistema Web de Suporte Técnico da Loja/Empresa 2.</p>
            <p>Realize a abertura do chamado para o técnico do suporte realizar a verificação ou manutenção.</center>

            <?php }elseif( $usuario["loja"] == 'Loja/Empresa 3' ){ ?>

            <center><p>Bem vindo <b><?php echo getUsuarioNome(); ?></b> ao Sistema Web de Suporte Técnico da Loja/Empresa 3.</p>
            <p>Realize a abertura do chamado para o técnico do suporte realizar a verificação ou manutenção.</center>
