            ...
            <table class="table table-hover  table-bordered">
                ...
                <tbody>
                  ...
                  <tr style="font-size: 15px;font-weight: normal;">
                    ...
                    <td><br><center> <a style="width: 80px;" href="/admin/calls/delete/<?php echo $value1["id_chamado"]; ?>"  onclick="return confirm('Deseja realmente excluir o chamado nº <?php echo $value1["id_chamado"]; ?>?')" class="btn btn-danger btn-sm"> Excluir</a></td>
