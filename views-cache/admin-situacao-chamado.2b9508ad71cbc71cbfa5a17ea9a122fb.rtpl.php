<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    <div class="content-inside">
        <div class="my-4">
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a style="background-color: #01A9DB;color: white" class="nav-link active" id="home-tab"
                        data-toggle="tab" role="tab" aria-controls="home" aria-selected="false"><b>Situação do chamado <?php echo $id_chamado["value"]; ?> </b></a>
                </li>
            </ul>
           ...
           <form class="form-group" action="/admin/chamado/atualizar-situacao/<?php echo $id_chamado["value"]; ?>" method="post">
